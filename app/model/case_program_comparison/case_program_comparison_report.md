...
- 当前刚跑出的 `app/output/result.csv` 在压缩包单切片打分口径下得分为 `0.032984`。
- 压缩包当前公开切片结果得分为 `0.025179`，因此当前版本 **已超过** 压缩包当前结果。
- 压缩包公开最好分数为 `0.037838`，因此当前版本 **仍低于** 压缩包公开最好分数。
- 相比上一版默认方案 `-0.038739`，当前版本已经进一步提高了 `0.071723`。
...
| current_live_case_slice_score | 0.032984179787833384 | 0.0251794912169185 | our_stronger |
| current_live_vs_case_reported_best | 0.032984179787833384 | 0.037838 | case_stronger |
...
| baseline_vs_other_our_models | mini4 beats lightgbm=0.125348, xgboost=-0.028796, transformer=0.123012 | N/A | our_stronger_internal_evidence |